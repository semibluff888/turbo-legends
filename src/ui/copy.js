...
export const UI_COPY = Object.freeze({
  ...
  settings: {
    ...
    rows: [
      ...
      { key: 'menuBgm', kind: 'choice', label: 'MENU BGM', desc: 'Random picks one track when entering the menus', options: MENU_BGM_CHOICES },
      { key: 'raceBgm', kind: 'choice', label: 'RACE BGM', desc: 'Default follows the track; Random picks one per race', options: RACE_BGM_CHOICES },
  ...
  online: {
    ...
    lobby: {
      ...
      search: 'Search rooms',
      searchPlaceholder: 'Search room, track, host, or code',
      newRoom: 'NEW ROOM',
      roomName: 'ROOM NAME',
      roomNamePlaceholder: 'Enter a room name',
      defaultRoomName: 'Competition Room',
      unnamedRoom: 'Unnamed Room',
      unknownHost: 'Unknown racer',
      roomType: 'ROOM TYPE',
      publicRoom: 'Public - no password',
      privateRoom: 'Private - password required',
      maxPlayers: 'PLAYER LIMIT',
      track: 'TRACK',
      password: 'PASSWORD',
      passwordPlaceholder: '3-20 characters',
      ...
      privateRoomHeading: 'PRIVATE ROOM',
      joinRoom: 'JOIN ROOM',
      players: 'PLAYERS',
      host: 'HOST',
      statusLabel: 'Status',
    ...
    room: {
      ...
      yourRacer: 'YOUR RACER',
      customize: 'CUSTOMIZE',
      customizeRacer: 'CUSTOMIZE RACER',
      loadoutEyebrow: 'YOUR LOOK',
      racerTab: 'RACER',
      paintTab: 'PAINT',
      avatarTab: 'AVATAR',
      save: 'SAVE',
      ...
      autoFillAi: 'AUTO-FILL OPEN SLOTS WITH AI',
      autoFillAiHelp: 'When the race starts, AI racers fill the remaining room slots.',
      ...
      offline: 'OFFLINE',
      reconnecting: 'RECONNECTING',
      reconnectingHint: 'Connection lost. This seat is reserved while the racer reconnects.',
      kickPlayer: 'Remove {name} from the room',
      kickTitle: 'REMOVE RACER?',
      kickMessage: 'Remove {name} from this room?',
      kickConfirm: 'REMOVE',
      kickedMessage: 'You were removed from the room by the host.',
      restoringSession: 'Restoring your room session...',
      leave: 'LEAVE ROOM',
      readyUp: 'READY UP',
      ...
      waitingForReconnect: 'Waiting for {name} to reconnect.',
      waitingForReconnectCount: 'Waiting for {count} racers to reconnect.',
    ...
    errors: {
      ...
      PASSWORD_REQUIRED: 'Enter a case-sensitive password between 3 and 20 characters.',
