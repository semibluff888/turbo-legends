...
const EN_COPY = {
  ...
  character: { heading: 'PICK YOUR RACER', hint: 'Arrows to browse · Enter to pick · Esc to go back' },
...
const ZH_COPY = {
  ...
  character: { heading: '选择你的车手', hint: '方向键浏览 · Enter 选择 · Esc 返回' },
  ...
  online: {
    ...
    room: {
      unnamedRoom: '在线房间', back: '返回', copyInvite: '复制邀请链接', copied: '邀请链接已复制', copyFallback: '邀请链接已复制', copyFailed: '无法复制邀请链接，请重试。', publicRoom: '公开', privateRoom: '私人', playerCount: '{count}/{max} 名车手', racers: '车手', chooseRacer: '选择你的车手', yourRacer: '你的车手', customize: '自定义', customizeRacer: '自定义车手', loadoutEyebrow: '你的外观', racerTab: '车手', paintTab: '涂装', avatarTab: '头像', save: '保存', cancel: '取消', close: '关闭自定义窗口', raceSetup: '比赛设置', track: '赛道', difficulty: 'AI 难度', autoFillAi: '使用 AI 填补空位', autoFillAiHelp: '比赛开始时，AI 车手会填补房间中的剩余空位。', hostControls: '你是房主。修改比赛设置会重置所有人的准备状态。', hostOnly: '只有房主可以修改比赛设置。', openSlot: '空位', choosing: '正在选择车手…', taken: '已选择', you: '你', host: '房主', ready: '已准备', notReady: '未准备', inGame: '比赛中', offline: '离线', reconnecting: '重连中', reconnectingHint: '连接已中断，重连期间会为该车手保留席位。', kickPlayer: '将 {name} 移出房间', kickTitle: '移出车手？', kickMessage: '确定要将 {name} 移出房间吗？', kickConfirm: '移出', kickedMessage: '房主已将你移出房间。', restoringSession: '正在恢复房间会话…', leave: '离开房间', readyUp: '准备', cancelReady: '取消准备', start: '开始比赛', loading: '正在加载比赛…', waitingForRacer: '正在等待至少一名车手加入', waitingForReconnect: '正在等待 {name} 重新连接。', waitingForReconnectCount: '正在等待 {count} 名车手重新连接。', readyCount: '{ready} / {total} 名车手已准备', readyToStart: '所有人都已准备，可以开始比赛！', waitingForHost: '所有人都已准备，正在等待房主', phase: { loading: '正在加载比赛…', countdown: '比赛即将开始…', racing: '比赛正在进行。', results: '正在等待车手返回房间。' },
    },
