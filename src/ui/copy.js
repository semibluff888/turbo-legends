...
const EN_COPY = {
  ...
  online: {
    ...
    lobby: {
      heading: 'MULTIPLAYER LOBBY', back: 'BACK', playerSetup: 'Player setup', nickname: 'NICKNAME', nicknamePlaceholder: 'Enter your racer name', quickMatch: 'QUICK START', createRoom: 'CREATE ROOM', roomList: 'AVAILABLE ROOMS', search: 'Search rooms', searchPlaceholder: 'Search room, track, host, or code', newRoom: 'NEW ROOM', roomName: 'ROOM NAME', roomNamePlaceholder: 'Enter a room name', defaultRoomName: 'Competition Room', unnamedRoom: 'Unnamed Room', unknownHost: 'Unknown racer', botRoomName: 'Bot Room', botHostName: 'Cyber Host', roomType: 'ROOM TYPE', publicRoom: 'Public - no password', privateRoom: 'Private - password required', maxPlayers: 'PLAYER LIMIT', track: 'TRACK', password: 'PASSWORD', passwordPlaceholder: '3-20 characters', passwordHelp: 'Passwords are case-sensitive.', enterPassword: 'Enter the room password', publicBadge: 'PUBLIC', privateBadge: 'PRIVATE', botBadge: 'BOT', passwordRequired: 'Password required', noPasswordRequired: 'No password required', privateRoomHeading: 'PRIVATE ROOM', joinRoom: 'JOIN ROOM', players: 'PLAYERS', host: 'HOST', statusLabel: 'Status', status: { waiting: 'WAITING', full: 'FULL', in_game: 'IN GAME' }, join: 'JOIN', create: 'CREATE', cancel: 'CANCEL', close: 'Close dialog', roomFull: 'This room is full.', roomInGame: 'This room is already racing.', noRooms: 'No rooms are available yet', noRoomsHint: 'Create a room or wait for another racer to open one.', noSearchResults: 'No rooms match your search', tryAnotherSearch: 'Try a room name, host nickname, or six-character code.', roomCount: '{count} rooms online', searchCount: '{count} matching rooms', inviteLocated: 'Invite found: {roomName}', inviteMissing: 'Room {roomCode} is not currently available.',
    },
    room: {
      unnamedRoom: 'ONLINE ROOM', botRoomName: 'Bot Room', botHostName: 'Cyber Host', back: 'BACK', copyInvite: 'Copy invite link', copied: 'INVITE LINK COPIED', copyFallback: 'INVITE LINK COPIED', copyFailed: 'The invite link could not be copied. Please try again.', publicRoom: 'PUBLIC', privateRoom: 'PRIVATE', playerCount: '{count}/{max} RACERS', racers: 'RACERS', chooseRacer: 'CHOOSE YOUR KART', yourRacer: 'YOUR RACER', customize: 'CUSTOMIZE', customizeRacer: 'CUSTOMIZE RACER', loadoutEyebrow: 'YOUR LOOK', racerTab: 'KART', paintTab: 'PAINT', avatarTab: 'AVATAR', save: 'SAVE', cancel: 'CANCEL', close: 'Close customization', raceSetup: 'RACE SETUP', track: 'TRACK', difficulty: 'AI DIFFICULTY', autoFillAi: 'AUTO-FILL OPEN SLOTS WITH AI', autoFillAiHelp: 'When the race starts, AI racers fill the remaining room slots.', hostControls: 'You are the host. Setup changes reset everyone\'s ready state.', hostOnly: 'Only the host can change the race setup.', botControls: 'Bot room setup is read-only. Use /m <number> to change the map and /s to start.', openSlot: 'Open slot', choosing: 'Choosing kart…', taken: 'TAKEN', you: 'YOU', host: 'HOST', botBadge: 'BOT', botReady: 'READY', ready: 'READY', notReady: 'NOT READY', inGame: 'IN GAME', offline: 'OFFLINE', reconnecting: 'RECONNECTING', reconnectingHint: 'Connection lost. This seat is reserved while the racer reconnects.', kickPlayer: 'Remove {name} from the room', kickTitle: 'REMOVE RACER?', kickMessage: 'Remove {name} from this room?', kickConfirm: 'REMOVE', kickedMessage: 'You were removed from the room by the host.', restoringSession: 'Restoring your room session...', chat: 'ROOM CHAT', chatPlaceholder: 'Type a message', chatEmpty: 'No messages yet.', sendChat: 'SEND', system: 'SYSTEM', chatRateLimited: 'You are sending messages too quickly. Please try again later.', leave: 'LEAVE ROOM', readyUp: 'READY UP', cancelReady: 'CANCEL READY', start: 'START RACE', loading: 'Loading the race…', waitingForRacer: 'Waiting for at least one more racer', waitingForReconnect: 'Waiting for {name} to reconnect.', waitingForReconnectCount: 'Waiting for {count} racers to reconnect.', readyCount: '{ready} / {total} racers ready', readyToStart: 'Everyone is ready — start the race!', waitingForHost: 'Everyone is ready — waiting for the host', botReadyToStart: 'Everyone is ready — send /s to start the race.', botMessages: { welcome: 'Welcome, {displayName}! Send /h to see Bot commands.', help: 'Commands: /h help, /m <number> change map, /s start. Maps: {maps}. Current map: {currentMapNumber}={currentMapName}.', helpShort: 'Commands: /h help, /m <number> change map, /s start.', mapInvalid: 'Invalid map number. Enter one number from {min} to {max}.', mapUnavailable: 'The map cannot be changed right now.', mapCooldown: 'Map change is cooling down. Wait {seconds}s.', mapChanged: 'Map changed to {mapNumber}: {mapName}. Please ready up again.', mapUnchanged: 'The current map is already {mapNumber}: {mapName}.', waitReady: 'Please wait until everyone is ready' }, phase: { loading: 'Loading the race…', countdown: 'The race is starting…', racing: 'Race in progress.', results: 'Waiting for racers to return to the room.' },
      botReadyTimeoutKicked: '{displayName} was removed after being unready for more than {timeoutSeconds} seconds.',
      systemMessages: { playerKickedByHost: '{displayName} was removed from the room by the host.' },
      kickedReadyTimeoutMessage: 'You were removed from the Bot room after being unready for more than {seconds} seconds.',
    },
...
const ZH_COPY = {
  ...
  online: {
    ...
    lobby: {
      heading: '多人在线大厅', back: '返回', playerSetup: '玩家设置', nickname: '昵称', nicknamePlaceholder: '输入你的车手昵称', quickMatch: '快速开始', createRoom: '创建房间', roomList: '可加入的房间', search: '搜索房间', searchPlaceholder: '搜索房间、赛道、房主或房间码', newRoom: '新建房间', roomName: '房间名称', roomNamePlaceholder: '输入房间名称', defaultRoomName: '竞速房间', unnamedRoom: '未命名房间', unknownHost: '未知车手', botRoomName: 'Bot自建房', botHostName: '赛博房主', roomType: '房间类型', publicRoom: '公开房间 - 无需密码', privateRoom: '私人房间 - 需要密码', maxPlayers: '玩家上限', track: '赛道', password: '密码', passwordPlaceholder: '3-20 个字符', passwordHelp: '密码区分大小写。', enterPassword: '输入房间密码', publicBadge: '公开', privateBadge: '私人', botBadge: 'BOT', passwordRequired: '需要密码', noPasswordRequired: '无需密码', privateRoomHeading: '私人房间', joinRoom: '加入房间', players: '玩家', host: '房主', statusLabel: '状态', status: { waiting: '等待中', full: '已满', in_game: '比赛中' }, join: '加入', create: '创建', cancel: '取消', close: '关闭对话框', roomFull: '该房间人数已满。', roomInGame: '该房间正在比赛。', noRooms: '暂时没有可用房间', noRoomsHint: '创建一个房间，或等待其他车手开放房间。', noSearchResults: '没有符合搜索条件的房间', tryAnotherSearch: '尝试搜索房间名、房主昵称或六位房间码。', roomCount: '当前有 {count} 个房间', searchCount: '找到 {count} 个房间', inviteLocated: '已找到邀请房间：{roomName}', inviteMissing: '房间 {roomCode} 当前不可用。',
    },
    room: {
      unnamedRoom: '在线房间', botRoomName: 'Bot自建房', botHostName: '赛博房主', back: '返回', copyInvite: '复制邀请链接', copied: '邀请链接已复制', copyFallback: '邀请链接已复制', copyFailed: '无法复制邀请链接，请重试。', publicRoom: '公开', privateRoom: '私人', playerCount: '{count}/{max} 名车手', racers: '车手', chooseRacer: '选择你的赛车', yourRacer: '你的车手', customize: '自定义', customizeRacer: '自定义车手', loadoutEyebrow: '你的外观', racerTab: '赛车', paintTab: '涂装', avatarTab: '头像', save: '保存', cancel: '取消', close: '关闭自定义窗口', raceSetup: '比赛设置', track: '赛道', difficulty: 'AI 难度', autoFillAi: '使用 AI 填补空位', autoFillAiHelp: '比赛开始时，AI 车手会填补房间中的剩余空位。', hostControls: '你是房主。修改比赛设置会重置所有人的准备状态。', hostOnly: '只有房主可以修改比赛设置。', botControls: 'Bot 房设置为只读，请使用 /m 数字修改地图、/s 开始比赛。', openSlot: '空位', choosing: '正在选择赛车…', taken: '已选择', you: '你', host: '房主', botBadge: 'BOT', botReady: '已准备', ready: '已准备', notReady: '未准备', inGame: '比赛中', offline: '离线', reconnecting: '重连中', reconnectingHint: '连接已中断，重连期间会为该车手保留席位。', kickPlayer: '将 {name} 移出房间', kickTitle: '移出车手？', kickMessage: '确定要将 {name} 移出房间吗？', kickConfirm: '移出', kickedMessage: '房主已将你移出房间。', restoringSession: '正在恢复房间会话…', chat: '房间聊天', chatPlaceholder: '输入聊天内容', chatEmpty: '暂无聊天消息', sendChat: '发送', system: '系统', chatRateLimited: '发送消息过快，请稍后再试', leave: '离开房间', readyUp: '准备', cancelReady: '取消准备', start: '开始比赛', loading: '正在加载比赛…', waitingForRacer: '正在等待至少一名车手加入', waitingForReconnect: '正在等待 {name} 重新连接。', waitingForReconnectCount: '正在等待 {count} 名车手重新连接。', readyCount: '{ready} / {total} 名车手已准备', readyToStart: '所有人都已准备，可以开始比赛！', waitingForHost: '所有人都已准备，正在等待房主', botReadyToStart: '所有人都已准备，发送 /s 开始比赛。', botMessages: { welcome: '欢迎 {displayName} 加入房间！发送 /h 查看指令。', help: '指令：/h 帮助、/m <数字> 修改地图、/s 开始比赛。地图：{maps}。当前地图：{currentMapNumber}={currentMapName}。', helpShort: '可用指令：/h 帮助、/m <数字> 修改地图、/s 开始比赛。', mapInvalid: '地图编号无效，请输入 {min}-{max} 的单个数字。', mapUnavailable: '当前无法修改地图。', mapCooldown: '地图修改冷却中，请等待 {seconds} 秒。', mapChanged: '地图已修改为 {mapNumber}：{mapName}。请重新准备。', mapUnchanged: '当前已经是地图 {mapNumber}：{mapName}。', waitReady: '请等待所有人准备' }, phase: { loading: '正在加载比赛…', countdown: '比赛即将开始…', racing: '比赛正在进行。', results: '正在等待车手返回房间。' },
      botReadyTimeoutKicked: '玩家 {displayName} 因超过 {timeoutSeconds} 秒未准备，已被移出房间。',
      systemMessages: { playerKickedByHost: '玩家 {displayName} 已被房主移出房间。' },
      kickedReadyTimeoutMessage: '你因超过 {seconds} 秒未准备，已被移出 Bot 房间。',
    },
